...
public class StaticReferenceClass {
    ...
    public static final String sURL = "http://192.168.1.15:8040/api/";//"http://173.82.114.197:9000/api/";//"http://192.168.1.4
    public static final String SERVER_URL = "192.168.1.15";

    public static final int PORT_NO = 8040;
    ...
    public static final String DB_NAME = "Trufrost-server1";

    public static final String USER_ID = "admin";//"vijay@gmail.com";//"vijay.eh4@gmail.com";//"admin";//
    public static final String PASSWORD = "autochip@505";//"auto
}
